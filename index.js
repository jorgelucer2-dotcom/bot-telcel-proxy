                ...
                if (miId === ejecucionesUsuario.get(id)) {
                    ...
                    if (clasificacionFinal.estado === 'EXITO') {
                        ...
                        mensajeTelegram = 
                            ...
                            `━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n` +
                            `👉 <b>Puedes hacer otra recarga con los mismos datos o volver al menú.</b>`;

                        const tecladoExito = sExito.guiadoRecarga
                            ? Markup.inlineKeyboard([
                                [Markup.button.callback('🔄 OTRA RECARGA — MISMOS DATOS', 'rec_otra_mismos_datos')],
...
async function prepararOtraRecargaMismosDatos(ctx, s) {
    const id = ctx.chat?.id || ctx.from?.id;
    if (!s || !s.guiadoRecarga || !s.numero || !s.monto || !(s.tarjeta || s.cc)) {
